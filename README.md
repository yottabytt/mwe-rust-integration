when `cargo test` is run, it creates five binaries as we can see in [target/debug/deps](https://github.com/yottabytt/mwe-rust-integration/tree/main/meow/target/debug/deps) directory. 
